...
function WhyUs() {
  ...
  const opportunitiesImage = language === "es" ? "cgx-opportunities-clean.png" : "cgx-opportunities-en.png";
    ...
    <section id="why-us" className="bg-slate-100 py-24">
      <Container>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          ...
          <img data-reveal="right" loading="lazy" src={`${import.meta.env.BASE_URL}assets/${opportunitiesImage}`} alt={language === "es" ? "Generamos oportunidades internacionales" : "We create international opportunities"} className="mx-auto max-h-[680px] rounded-2xl object-cover shadow-2xl" />
        </div>
      </Container>
    </section>
  );

    ...
    <section className="bg-white py-24">
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <img data-reveal="left" loading="lazy" src={`${import.meta.env.BASE_URL}assets/cgx-market-regenerated.png`} alt={language === "es" ? "El mundo es tu próximo mercado" : "The world is your next market"} className="order-2 mx-auto max-h-[680px] rounded-2xl object-contain shadow-2xl lg:order-1" />

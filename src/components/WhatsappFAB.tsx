...
function WhatsappFAB() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-4 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-green-950/30 transition duration-300 hover:scale-110 hover:bg-[#20bd5a] hover:shadow-2xl hover:shadow-green-500/40 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-green-400/40 sm:bottom-auto sm:right-6 sm:top-1/2 sm:h-16 sm:w-16 sm:-translate-y-1/2 sm:hover:-translate-y-1/2"
    >
      ...
      <svg
        viewBox="0 0 32 32"
        aria-hidden="true"
        className="h-7 w-7 fill-current transition duration-300 group-hover:-rotate-12 group-hover:scale-110 sm:h-9 sm:w-9"
      >
